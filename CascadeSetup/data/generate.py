...
with open("positives.txt") as f:
	...
	for target in content:
		...
		subprocess.call('E:/openCV/opencv3.0/build/x64/vc14/bin/opencv_createsamples.exe -bg negatives.txt -info data/annotations'+str(count)+'.lst -maxxangle 0.2 -maxyangle 0.2 -maxzangle 0.5 -bgthresh 40 -h 50 -w 75 -num 300 -img '+target, shell=True)
	...
	subprocess.call('E:/openCV/opencv3.0/build/x64/vc14/bin/opencv_createsamples.exe -vec presto.vec -info data/annotations.lst -num '+str(totalPositiveSamples)+' -h 50 -w 75', shell=True)
	
	subprocess.call('E:/openCV/opencv3.0/build/x64/vc14/bin/opencv_createsamples.exe -vec presto.vec -h 50 -w 75', shell=True)
